  ...
  if (loading)
    return (
      <div className="flex items-center justify-center h-96">
        ...
        <span className="text-zinc-500 text-sm md:text-base">Loading orders...</span>
      </div>
    );
    ...
    <div className="space-y-4 md:space-y-6">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          ...
          <p className="text-zinc-500 text-sm md:text-base mt-1">View and manage customer orders.</p>
        </div>
      </div>
          ...
          <table className="min-w-full divide-y divide-zinc-200">
            <thead className="bg-zinc-50/50">
              <tr>
                ...
                <th className="px-4 md:px-6 py-3 text-left text-[10px] md:text-xs font-semibold text-zinc-500 uppercase tracking-wider">Total</th>
