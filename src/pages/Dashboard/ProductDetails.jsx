          ...
          <div className="p-4 md:p-6 space-y-4">
            ...
            <div className="space-y-3 md:space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="Title"
                  className="w-full border border-zinc-200 rounded-lg px-3 md:px-4 py-2 border-zinc-200 focus:outline-none focus:ring-2 focus:ring-zinc-900 text-sm md:text-base"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="Price"
                  className="w-full border border-zinc-200 rounded-lg px-3 md:px-4 py-2 focus:outline-none focus:ring-2 focus:ring-zinc-900 text-sm md:text-base"
                />
              </div>
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full border border-zinc-200 rounded-lg px-3 md:px-4 py-2 bg-white focus:outline-none focus:ring-2 focus:ring-zinc-900 text-sm md:text-base"
                >
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-4 border-t border-zinc-100">
              <button
                onClick={handleSave}
                disabled={saving}
                className="w-full sm:w-auto justify-center bg-zinc-900 text-white px-4 py-2 rounded-lg font-medium hover:bg-zinc-800 transition flex items-center gap-2 disabled:opacity-50"
              >
              ...
              <button
                ...
                className="w-full sm:w-auto justify-center bg-zinc-100 text-zinc-700 px-4 py-2 rounded-lg font-medium hover:bg-zinc-200 transition flex items-center gap-2"
              >
            ...
            <div className="p-4 md:p-6">
              ...
              <div className="flex gap-3 pt-4 border-t border-zinc-100">
                <button
                  ...
                  className="w-full sm:w-auto justify-center bg-zinc-900 text-white px-5 py-2.5 rounded-lg font-medium hover:bg-zinc-800 transition flex items-center gap-2 shadow-sm shadow-zinc-900/10"
                >
