      ...
      <div className="bg-white border border-zinc-200 rounded-xl shadow-sm p-4 md:p-6">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
          ...
          <div className="md:col-span-2 flex justify-end mt-2 md:mt-0">
            <button
              type="submit"
              className="w-full md:w-auto bg-zinc-900 text-white px-6 py-2.5 rounded-lg font-medium hover:bg-zinc-800 transition shadow-sm flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
              disabled={actionLoading && actionType === "create"}
            >
        ...
        {Array.isArray(products) && products.map((p) => (
          ...
          >
            <div className="aspect-[4/3] sm:aspect-video bg-zinc-100 overflow-hidden relative shrink-0">
              ...
              <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-3">
                <button
                  ...
                  className="p-2 md:p-3 bg-white text-zinc-900 rounded-full hover:bg-zinc-50 transition"
                  title="View Details"
                >
                ...
                <button
                  ...
                  className="p-2 md:p-3 bg-red-600 text-white rounded-full hover:bg-red-700 transition disabled:opacity-50"
            ...
            <div className="p-3 md:p-4 flex flex-col flex-1">
              ...
              <p className="text-xs md:text-sm text-zinc-600 line-clamp-2 md:line-clamp-2 min-h-[2.5em]">{p.description}</p>
            </div>
          </div>
        ))}
