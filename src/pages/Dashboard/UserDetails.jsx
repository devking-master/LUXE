  ...
  if (loading)
    return (
      <div className="flex items-center justify-center h-96">
        ...
        <span className="text-zinc-500 font-medium">Loading user...</span>
      </div>
    );
  if (error)
    return (
  ...
  return (
    <div className="max-w-xl mx-auto space-y-6">
       <div className="flex items-center gap-4">
         ...
         <h1 className="text-xl font-bold tracking-tight text-zinc-900">User Details</h1>
       </div>

      <div className="bg-white border border-zinc-200 rounded-xl shadow-sm overflow-hidden">
        <div className="p-8 flex flex-col items-center bg-zinc-50/50 border-b border-zinc-100">
           <img
        ...
        <div className="p-8 space-y-6">
           <div>
              <label className="block text-sm font-medium text-zinc-700 mb-2 flex items-center gap-2">
                 <Shield className="w-4 h-4 text-zinc-400" /> Role Management
              </label>
              <select
                value={role}
                onChange={(e) => setRole(e.target.value)}
                className="w-full border border-zinc-200 rounded-lg px-4 py-3 bg-white focus:outline-none focus:ring-2 focus:ring-zinc-900"
              >
           ...
           <button
             ...
             disabled={saving}
             className="w-full bg-zinc-900 text-white px-6 py-3 rounded-lg font-medium hover:bg-zinc-800 transition flex items-center justify-center gap-2 shadow-lg shadow-zinc-900/10 disabled:opacity-50"
           >
